		...
		<div class="mx-auto mb-12 max-w-4xl text-center">
			...
			<div class="mt-8 flex justify-center">
				<Button
					...
					variant="outline"
					size="lg"
					class="group relative overflow-hidden border-primary/50 bg-background/50 hover:bg-primary/10"
				>
					<span class="relative z-10 flex items-center gap-2 font-medium">
						<svg
							...
							><path d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7" /><path
								d="M4 12v8a2 2 0 0 0 2 2h2v-4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v4h2a2 2 0 0 0 2-2v-8"
							/><path d="M2 7h20" /><path
